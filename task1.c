 ...
 *
 * Workload distribution: cyclic. Process r tests the odd numbers
 * 3 + 2r, 3 + 2r + 2*size, 3 + 2r + 4*size, ...
 * so every process gets an even mix of small and large numbers.
 */
...
int main(int argc, char *argv[]) {
    ...
    /* cyclic distribution: start at 3 + 2*rank, step by 2*size (odd numbers only) */
